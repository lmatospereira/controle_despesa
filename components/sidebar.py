...
layout = dbc.Card([
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            ...
                            html.P(
                                "Um Card com exemplo do perfil Homem.\
                                     Texto para preencher o espaço",
                                className="card-text",
                                ),
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            ...
                            html.P(
                                "Um Card com exemplo do perfil Mulher. \
                                    Texto para preencher o espaço",
                                className="card-text",
                                ),
                            dbc.Button("Acessar", color="warning"),
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            ...
                            html.P(
                                "Um Card com exemplo do perfil Casa.\
                                Texto para preencher o espaço",
                                className="card-text",
                            ),
                            dbc.Button("Acessar",  color="warning"),
                    ...
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            ...
                            html.P(
                                ...
                                o botão de adicionar um novo perfil esta \
    ...
    ThemeChangerAIO(
        aio_id="theme", radio_props={"value": dbc.themes.MATERIA})
...
def add_category(n, n2, txt, check_delete, data):
    ...
    if n:
        if txt == "" or txt is None:
            txt1 = "O campo de texto não pode estar vazio\
                 para o registro de uma nova categoria."
            style1 = {'color': 'red'}
